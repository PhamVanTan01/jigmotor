...
## Corpus Check
- 580 files · ~10,690,905 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5809 nodes · 11636 edges · 339 communities (325 shown, 14 thin omitted)
...
Cohesion: 0.04
Nodes (84): NonlinearEngine_RequestStart(), MemPool_t, AllocBlock(), StackType_t, __STATIC_INLINE, StaticTask_t, TaskHandle_t, __WEAK (+76 more)
...
Cohesion: 0.07
Nodes (73): configSTACK_DEPTH_TYPE, eNotifyAction, eTaskState, MemoryRegion_t, osThreadTerminate(), UBaseType_t, uxListRemove(), BaseType_t (+65 more)
...
Cohesion: 0.10
Nodes (64): osMessageQueueGet(), osMessageQueueGetCount(), xCoRoutineRemoveFromEventList(), BaseType_t, TaskHandle_t, TickType_t, UBaseType_t, pcQueueGetName() (+56 more)
...
### Community 27 - "__DSB"
Cohesion: 0.13
Nodes (39): __DSB(), __ISB(), __NVIC_SystemReset(), __NVIC_SystemReset(), IRQn_Type, __STATIC_INLINE, ITM_CheckChar(), ITM_ReceiveChar() (+31 more)
...
Cohesion: 0.11
Nodes (33): MA600_AcquisitionContext_t, MA600_Sample_t, MA600_AcquireSample(), MA600_AcquisitionInit(), MA600_UnwrappedRawToDegrees(), MA600_Result_t, Motor_ElectricalOffset(), Motor_Enable() (+25 more)
...
Cohesion: 0.10
Nodes (45): TimerHandle_t, osTimerDelete(), osTimerGetName(), osTimerIsRunning(), osTimerNew(), osTimerStart(), osTimerStop(), TimerCallback() (+37 more)
...
### Community 44 - "vTaskSuspendAll"
Cohesion: 0.11
Nodes (37): EventBits_t, EventGroupHandle_t, osEventFlagsClear(), osEventFlagsDelete(), osEventFlagsGet(), osEventFlagsNew(), osEventFlagsSet(), osEventFlagsWait() (+29 more)
...
### Community 48 - "TickType_t"
Cohesion: 0.10
Nodes (32): crCOROUTINE_CODE, osThreadFlagsWait(), BaseType_t, List_t, TickType_t, UBaseType_t, prvCheckDelayedList(), prvCheckPendingReadyList() (+24 more)
...
### Community 65 - "stm32f4xx_hal_rcc.c"
Cohesion: 0.17
...
### Community 91 - "task.h"
Cohesion: 0.10
Nodes (12): TaskHandle_t, vApplicationMallocFailedHook(), vApplicationStackOverflowHook(), gremsyMotorDisable(), gremsyMotorEnable(), gremsyMotorInit(), gremsyMotorMoveAngle(), gremsyMotorMovePos() (+4 more)
...
Cohesion: 0.11
Nodes (29): ControlA4Report_t, ControlA4Result_t, ControlA5Sample_t, AppEngine_Init(), ControlA5_CaptureResourcesReleaseForInitFailure(), ControlA5_GetEvidenceBuffer(), AbsI32ToU32(), ControlA5CaptureReport_t (+21 more)

### Community 311 - "nonlinear_test.c"
Cohesion: 0.09
Nodes (55): ClosureProbeStageName(), ComputeFittedMinMaxDenseByOrders(), ComputeHarmonicFull(), ComputeModelMetricsByOrders(), ComputeResidualRms(), ComputeShadowMetrics(), FindHarmonic(), FindKnownJigByUid() (+47 more)
...
### Community 315 - "pvPortMalloc"
Cohesion: 0.16
Nodes (17): BlockLink_t, ControlA5_CaptureResourcesInit(), HeapStats_t, osMemoryPoolNew(), osThreadEnumerate(), osThreadGetCount(), prvHeapInit(), prvInsertBlockIntoFreeList() (+9 more)
...
### Community 335 - "MoveToZeroAndCheckDirection"
Cohesion: 0.39
...
## Knowledge Gaps
- **1259 isolated node(s):** `v`, `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed` (+1254 more)
...
- **Why does `HAL_GetTick()` connect `HAL_GetTick` to `stm32f4xx_hal_rcc.c`, `stm32f4xx_hal.c`, `stm32f4xx_hal_rcc_ex.c`, `stm32f4xx_hal_uart.c`, `stm32f4xx_hal_spi.c`, `MoveToZeroAndCheckDirection`, `stm32f4xx_hal_dma.c`, `ControlRunA5`, `stm32f4xx_hal_adc.c`, `control_engine.c`, `nonlinear_test.c`, `CaptureSweep`, `stm32f4xx_hal_flash_ex.c`, `stm32f4xx_hal_i2c.c`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `LL_MPU_Enable()` connect `stm32f4xx_ll_cortex.h` to `__DSB`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `Error_Handler()` connect `main` to `cmsis_gcc.h`, `stm32f4xx_hal_gpio.c`, `TIM_Base_SetConfig`, `task.h`, `stm32f4xx_hal_cortex.c`?**
