...
## Corpus Check
- 530 files · ~10,042,394 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5589 nodes · 11432 edges · 319 communities (306 shown, 13 thin omitted)
...
Cohesion: 0.03
Nodes (95): AppEngine_Init(), AppEngine_RequestStart(), ControlA5_CaptureResourcesReleaseForInitFailure(), ControlEngine_Init(), ControlEngine_RequestStart(), NonlinearEngine_RequestStart(), MemPool_t, AllocBlock() (+87 more)
...
Cohesion: 0.06
Nodes (87): BlockLink_t, configSTACK_DEPTH_TYPE, ControlA5_CaptureResourcesInit(), eNotifyAction, eTaskState, HeapStats_t, osKernelRestoreLock(), osThreadEnumerate() (+79 more)
...
Cohesion: 0.10
Nodes (65): osMessageQueueGet(), osMessageQueueGetCount(), xCoRoutineRemoveFromEventList(), BaseType_t, TaskHandle_t, TickType_t, UBaseType_t, pcQueueGetName() (+57 more)
...
Cohesion: 0.15
Nodes (28): EventBits_t, EventGroupHandle_t, osEventFlagsClear(), osEventFlagsGet(), osEventFlagsNew(), osEventFlagsSet(), osEventFlagsWait(), BaseType_t (+20 more)
...
Cohesion: 0.15
Nodes (17): crCOROUTINE_CODE, BaseType_t, List_t, TickType_t, UBaseType_t, prvCheckDelayedList(), prvCheckPendingReadyList(), prvInitialiseCoRoutineLists() (+9 more)
...
### Community 258 - "xTaskCreate"
Cohesion: 0.17
Nodes (19): MemoryRegion_t, osThreadNew(), StackType_t, StaticTask_t, TaskFunction_t, freertos_tasks_c_additions_init(), prvAddNewTaskToReadyList(), prvInitialiseNewTask() (+11 more)
...
Cohesion: 0.25
Nodes (7): 1. Fix v3 cho `ENABLE_SWEEP_POINT_CREEP` — giải quyết vấn đề nhiệt/giật cục (mục 6.5, tài liệu 08-04), 2. v3 THẤT BẠI trên phần cứng thật — công suất 0.6f không đủ lực, revert về v4, 3. v4 bất ổn định (cv 18-39% qua 3 remount) — phân tích không gian "điểm khó", 4. v5-adaptive-budget (phiên song song) — test trên P03, PHÁT HIỆN LỖI MỚI: target-crossing overshoot, 5. v5.1-crossing-guard — test trên P03, KẾT QUẢ: guard hoạt động đúng thiết kế nhưng KHÔNG đủ để dùng được, Hoạt động trong ngày, Nhật ký công việc 2026-08-05

### Community 309 - "RunNlMathSelfTestCase"
Cohesion: 0.40
...
### Community 310 - "HAL_SPI_RegisterCallback"
Cohesion: 0.50
...
Cohesion: 0.09
Nodes (51): Motor_GetCommandedPos(), Motor_ControllerState_t, ClosureProbeStageName(), ComputeSweepStats(), ControllerStateIsReset(), FindKnownJigByUid(), FinishEngineCommand(), FinishMoveToZeroObservation() (+43 more)
...
## Knowledge Gaps
- **1110 isolated node(s):** `v`, `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed` (+1105 more)
...
- **Why does `HAL_GetTick()` connect `HAL_GetTick` to `stm32f4xx_hal.c`, `stm32f4xx_hal_uart.c`, `stm32f4xx_hal_rcc_ex.c`, `stm32f4xx_hal_spi.c`, `stm32f4xx_hal_dma.c`, `ControlRunA5`, `stm32f4xx_hal_adc.c`, `CaptureSweep`, `nonlinear_test.c`, `stm32f4xx_hal_flash_ex.c`, `control_engine.c`, `stm32f4xx_hal_i2c.c`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `LL_MPU_Enable()` connect `stm32f4xx_ll_cortex.h` to `__DSB`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **Why does `osDelay()` connect `CaptureSweep` to `tasks.c`, `cmsis_os2.c`, `StartDefaultTask`, `nonlinear_test.c`?**
