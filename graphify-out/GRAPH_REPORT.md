# Graph Report - jigmotor  (2026-08-11)

## Corpus Check
- 624 files · ~11,498,979 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6106 nodes · 11932 edges · 384 communities (369 shown, 15 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 832 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5a833ebe`
...
Cohesion: 0.04
Nodes (79): MemPool_t, AllocBlock(), __STATIC_INLINE, TaskHandle_t, __WEAK, CreateBlock(), FreeBlock(), OS_Tick_GetCount() (+71 more)
...
Cohesion: 0.07
Nodes (75): configSTACK_DEPTH_TYPE, eNotifyAction, eTaskState, osThreadTerminate(), List_t, ListItem_t, UBaseType_t, uxListRemove() (+67 more)
...
Cohesion: 0.08
Nodes (57): DMA_HandleTypeDef, FlagStatus, HAL_StatusTypeDef, SPI_HandleTypeDef, __weak, HAL_SPI_Abort(), HAL_SPI_Abort_IT(), HAL_SPI_AbortCpltCallback() (+49 more)

### Community 14 - "queue.c"
Cohesion: 0.11
Nodes (63): osMessageQueueGetCount(), xCoRoutineRemoveFromEventList(), BaseType_t, TaskHandle_t, TickType_t, UBaseType_t, pcQueueGetName(), prvCopyDataFromQueue() (+55 more)
...
### Community 22 - "Plan test 7PP suy ra từ chuỗi thử nghiệm A→B"
Cohesion: 0.06
Nodes (32): 10. P7-AB4 — Static hold theo phương pháp A5, 11. P7-AB5 — A/B/A theo class, 12. P7-AB6 — Alignment/phase trajectory, chỉ khi được kích hoạt, 13. P7-AB7 — Kiểm tra sector và mapping, 14. P7-AB8 — Candidate confirmation, 15. P7-AB9 — Batch repeatability, 16. Tooling 7PP bắt buộc, 17. Thứ tự implementation (+24 more)
...
### Community 29 - "motor.c"
Cohesion: 0.09
Nodes (34): MA600_AcquisitionContext_t, MA600_Sample_t, MA600_AcquireSample(), MA600_UnwrappedRawToDegrees(), MA600_Result_t, Motor_Enable(), Motor_GetCommandedPos(), Motor_Init() (+26 more)
...
Cohesion: 0.12
Nodes (33): MA600_AcquisitionRunFaultInjectionSelfTest(), MA600_ReadMeta_t, MA600_Result_t, MA600_UnwrapContext_t, SPI_HandleTypeDef, Crc32IsoHdlc(), HAL_SPI_ErrorCallback(), HAL_SPI_TxRxCpltCallback() (+25 more)

### Community 33 - "core_armv8mbl.h"
Cohesion: 0.08
Nodes (54): __get_APSR(), __get_BASEPRI(), __get_CONTROL(), __get_FAULTMASK(), __get_FPSCR(), __get_IPSR(), __get_MSP(), __get_PRIMASK() (+46 more)
...
Cohesion: 0.10
Nodes (46): TimerHandle_t, osTimerDelete(), osTimerGetName(), osTimerIsRunning(), osTimerNew(), osTimerStart(), osTimerStop(), TimerCallback() (+38 more)
...
Cohesion: 0.14
Nodes (30): EventBits_t, EventGroupHandle_t, osEventFlagsClear(), osEventFlagsDelete(), osEventFlagsGet(), osEventFlagsNew(), osEventFlagsSet(), osEventFlagsWait() (+22 more)
...
### Community 48 - "task.h"
Cohesion: 0.11
Nodes (12): crCOROUTINE_CODE, BaseType_t, List_t, TickType_t, UBaseType_t, prvCheckDelayedList(), prvCheckPendingReadyList(), prvInitialiseCoRoutineLists() (+4 more)
...
### Community 61 - "port.c"
Cohesion: 0.11
Nodes (15): eSleepModeStatus, BaseType_t, StackType_t, TaskFunction_t, TickType_t, prvPortStartFirstTask(), prvTaskExitError(), pxPortInitialiseStack() (+7 more)

### Community 62 - "StartDefaultTask"
Cohesion: 0.17
Nodes (15): AppEngine_Init(), AppEngine_IsBusy(), AppEngine_ModeId(), AppEngine_ProfileFingerprint(), AppEngine_ProfileId(), AppEngine_RequestStart(), AppEngine_SourceId(), ControlEngine_IsBusy() (+7 more)
...
### Community 65 - "vTaskSuspendAll"
Cohesion: 0.13
Nodes (24): BlockLink_t, ControlA5_CaptureResourcesInit(), HeapStats_t, osKernelGetState(), osKernelLock(), osKernelRestoreLock(), osKernelUnlock(), osThreadEnumerate() (+16 more)
...
Cohesion: 0.23
Nodes (19): DMA_HandleTypeDef, HAL_StatusTypeDef, DMA_CalcBaseAndBitshift(), DMA_CheckFifoParam(), DMA_SetConfig(), HAL_DMA_Abort(), HAL_DMA_GetError(), HAL_DMA_GetState() (+11 more)
...
Cohesion: 0.23
Nodes (7): gremsyMotorEnable(), gremsyMotorInit(), gremsyMotorMoveAngle(), gremsyMotorMovePos(), gremsyMotorMoveSpeed(), gremsyMotorSetPWM(), limit_integer()
...
Cohesion: 0.05
Nodes (38): 10. Điều kiện hoàn thành V3, 11. Mở rộng V3.2 shifted-reversal cho 7PP, 1. Mục tiêu, 2. Baseline đã có, 3.1. Nguyên lý, 3.2. Phần giữ nguyên tuyệt đối, 3.3. Feature isolation, 3. Maneuver V3 (+30 more)
...
Cohesion: 0.09
Nodes (22): 10. P7.8 — V3.2 shifted-reversal theo raw electrical cycle, 11. P7.9 — Chẩn đoán hiện tượng khựng tại point 143–148, 12. P7.10 — Plan tích hợp từ chuỗi A→B, 1. Mục tiêu, 2.1. Giới hạn đã biết của bộ đổi pha PWM hiện tại, 2. Hình học bắt buộc, 3.1. Contract build cần bổ sung trước khi flash, 3. Cấu hình build thử nghiệm (+14 more)
...
### Community 217 - "Code implementation plan — test motor 7 cặp cực"
Cohesion: 0.10
Nodes (20): 1. Mục tiêu code, 2. Baseline gap của branch hiện tại, 3.1. Geometry dùng chung, 3.2. Profile identity, 3. Thiết kế cấu hình, 4. Work packages, 5. Thứ tự commit đề xuất, 6. Verification matrix (+12 more)
...
Cohesion: 0.12
Nodes (29): ControlA4Report_t, ControlA4Result_t, ControlA5_CaptureResourcesReleaseForInitFailure(), AbsI32ToU32(), ControlA5CaptureReport_t, ControlA5Result_t, MA600_Sample_t, ControlA4PhaseProgressRaw() (+21 more)

### Community 311 - "nonlinear_test.c"
Cohesion: 0.06
Nodes (66): AbsI64ToU64(), AccumulateCounterDelta(), MA600_AcquisitionContext_t, MA600_PointSample_t, MA600_PointSamplerConfig_t, MA600_Result_t, MA600_Sample_t, MA600_UnwrapContext_t (+58 more)
...
Cohesion: 0.14
Nodes (28): ADC_HandleTypeDef, I2C_HandleTypeDef, SPI_HandleTypeDef, TIM_HandleTypeDef, UART_HandleTypeDef, HAL_ADC_MspDeInit(), HAL_ADC_MspInit(), HAL_I2C_MspDeInit() (+20 more)
...
### Community 341 - "RampCommandToTargetTraced"
Cohesion: 0.17
Nodes (22): Motor_SetElectricalPos(), CompleteStutterSettleTrace(), ExtendCommandBlind(), LockStartPosition(), NlI64FitsI32(), NlSmoothstepCommandRaw(), RampCommandToTarget(), RampCommandToTargetTraced() (+14 more)
...
### Community 353 - "xTaskCreate"
Cohesion: 0.14
Nodes (23): MemoryRegion_t, StackType_t, StaticTask_t, osThreadNew(), vApplicationGetIdleTaskMemory(), vApplicationGetTimerTaskMemory(), StackType_t, StaticTask_t (+15 more)
...
### Community 358 - "Plan chẩn đoán hiện tượng khựng motor 1807 7PP"
Cohesion: 0.10
Nodes (19): 10. D5 — A/B/A tốc độ ramp, chỉ khi H2 hoặc mixed, 11. D6 — Phân biệt góc cơ khí và pha điện, 12. Candidate fix và thứ tự ưu tiên, 13. Tiêu chí chấp nhận candidate, 14. File bằng chứng phải lưu, 15. Decision tree, 1. Mục tiêu, 2. Bằng chứng kích hoạt plan (+11 more)
...
### Community 364 - "stm32f4xx_hal_cortex.c"
Cohesion: 0.17
Nodes (12): IRQn_Type, __weak, HAL_MPU_ConfigRegion(), HAL_MPU_Disable(), HAL_NVIC_ClearPendingIRQ(), HAL_NVIC_GetActive(), HAL_NVIC_GetPendingIRQ(), HAL_NVIC_GetPriority() (+4 more)

### Community 365 - "LogLine"
Cohesion: 0.23
Nodes (15): MA600_ConfigGateResultName(), FindKnownJigByUid(), FinishEngineCommand(), HasTimeElapsed(), LogLine(), NonlinearBatch_OnButtonPress(), NonlinearBatch_Poll(), NonlinearEngine_GetState() (+7 more)
...
### Community 371 - "motor_quality_polar.py"
Cohesion: 0.26
Nodes (11): Sweep, _circular_smooth(), generate_polar_quality_chart(), _mean_official_error_curve(), _parse_sweep_creep_gap(), _parse_sweep_point_timing(), Path, Post-save polar quality chart for one motor's log -- E(theta) fingerprint.… (+3 more)
...
### Community 374 - "RunNlMathSelfTestCase"
Cohesion: 0.40
...
### Community 376 - "Q: S2-P09-JIG8-remount01-test-1-v5-8"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: S2-P09-JIG8-remount01-test-1-v5-8, Source Nodes

### Community 377 - "Q: S2-P09-JIG8-remount02-test-1-v5-8 remount 2"
Cohesion: 0.40
Nodes (4): Answer, Outcome, Q: S2-P09-JIG8-remount02-test-1-v5-8 remount 2, Source Nodes

### Community 378 - "Q: S2-P09-JIG8-remount03-test-1-v5-8 remount 3"
Cohesion: 0.40
...
## Knowledge Gaps
- **1420 isolated node(s):** `v`, `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed` (+1415 more)
...
- `CreepToUnwrappedTargetProfiled()` (9× useful, score=8.97784659) _(code changed — re-verify)_
- `V5.6 — three-stage 16→8→4 response-qualified landing` (7× useful, score=6.806785518) _(code changed — re-verify)_
- `HardcapHoldClassification()` (4× useful, score=3.995160443) _(code changed — re-verify)_
- `V5.8-TIME-DIAG — đo thời gian đáp ứng command theo từng điểm` (2× useful, score=1.999111927) _(code changed — re-verify)_
- `V5.7-DIAG — Passive hold after the first V5.5 hard-cap failure` (2× useful, score=1.996048516) _(code changed — re-verify)_
- `RampCommandToTarget()` (2× useful, score=1.993500555) _(code changed — re-verify)_
- `WaitForPointSettle()` (2× useful, score=1.993500555) _(code changed — re-verify)_
- `12.4 Pilot A2 — generalization P03/JIG8` (2× useful, score=1.828620962) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `HAL_GetTick()` connect `HAL_GetTick` to `stm32f4xx_hal.c`, `stm32f4xx_hal_rcc_ex.c`, `stm32f4xx_hal_uart.c`, `LogLine`, `stm32f4xx_hal_spi.c`, `stm32f4xx_hal_dma.c`, `ControlRunA5`, `stm32f4xx_hal_adc.c`, `RampCommandToTargetTraced`, `control_engine.c`, `nonlinear_test.c`, `stm32f4xx_hal_flash_ex.c`, `stm32f4xx_hal_rcc.c`, `motor.c`, `stm32f4xx_hal_i2c.c`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `LL_MPU_Enable()` connect `stm32f4xx_ll_cortex.h` to `__DSB`?**
  _High betweenness centrality (0.031) - this node is a cross-community bridge._
- **Why does `Error_Handler()` connect `main` to `cmsis_gcc.h`, `stm32f4xx_hal_gpio.c`, `TIM_Base_SetConfig`, `gremsyMotor.c`, `stm32f4xx_hal_msp.c`?**
