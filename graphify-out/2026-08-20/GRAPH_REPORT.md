# Graph Report - jigmotor  (2026-08-20)

## Corpus Check
- 684 files · ~11,368,687 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6545 nodes · 12391 edges · 459 communities (447 shown, 12 thin omitted)
- Extraction: 93% EXTRACTED · 7% INFERRED · 0% AMBIGUOUS · INFERRED: 835 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9d5f51ac`
...
- analyze_nl_mount_vector_model.py
- stm32f4xx_hal_pwr.c
- syscalls.c
- __weak
...
- Q: Audit the methodological critique of the 2026-08-18 S4 cross-jig open-loop NL analysis.
...
## Communities (459 total, 12 thin omitted)
...
Cohesion: 0.04
Nodes (83): NonlinearEngine_RequestStart(), MemPool_t, AllocBlock(), __STATIC_INLINE, TimerHandle_t, CreateBlock(), FreeBlock(), OS_Tick_GetCount() (+75 more)
...
### Community 10 - "TIM_HandleTypeDef"
Cohesion: 0.10
Nodes (50): HAL_DMA_Abort_IT(), HAL_StatusTypeDef, TIM_HandleTypeDef, HAL_TIM_Base_Start(), HAL_TIM_Base_Start_DMA(), HAL_TIM_Base_Start_IT(), HAL_TIM_Base_Stop(), HAL_TIM_Base_Stop_DMA() (+42 more)

### Community 11 - "tasks.c"
Cohesion: 0.07
Nodes (68): configSTACK_DEPTH_TYPE, eNotifyAction, eTaskState, MemoryRegion_t, osThreadExit(), osThreadGetCount(), osThreadResume(), osThreadSuspend() (+60 more)
...
### Community 24 - "__WEAK"
Cohesion: 0.16
Nodes (14): StackType_t, StaticTask_t, TaskHandle_t, __WEAK, SysTick_Handler(), vApplicationDaemonTaskStartupHook(), vApplicationGetIdleTaskMemory(), vApplicationGetTimerTaskMemory() (+6 more)
...
### Community 29 - "Motor_MoveToAngle"
Cohesion: 0.32
...
Cohesion: 0.07
Nodes (61): __get_APSR(), __get_BASEPRI(), __get_CONTROL(), __get_FAULTMASK(), __get_FPSCR(), __get_IPSR(), __get_MSP(), __get_PRIMASK() (+53 more)
...
Cohesion: 0.14
Nodes (35): UBaseType_t, uxListRemove(), BaseType_t, TaskHandle_t, TickType_t, TimerHandle_t, UBaseType_t, pcTimerGetName() (+27 more)
...
### Community 38 - "LogLine"
Cohesion: 0.23
Nodes (16): FindKnownJigByUid(), FinishEngineCommand(), HasTimeElapsed(), LogLine(), LogLineLarge(), NonlinearBatch_OnButtonPress(), NonlinearBatch_Poll(), NonlinearEngine_GetState() (+8 more)
...
Cohesion: 0.15
Nodes (24): ControlA5AbortRequestedFn_t, ControlA5Sample_t, ControlA5CaptureReport_t, ControlA5Result_t, Motor_ControllerState_t, ControlA5_AbsI32(), ControlA5_CaptureReportInit(), ControlA5_CaptureResourcesReady() (+16 more)
...
### Community 60 - "stm32f4xx_hal_tim.c"
Cohesion: 0.09
Nodes (46): DMA_HandleTypeDef, HAL_TIM_ChannelStateTypeDef, HAL_TIM_StateTypeDef, __weak, HAL_TIM_Base_DeInit(), HAL_TIM_Base_GetState(), HAL_TIM_Base_MspDeInit(), HAL_TIM_DMABurstState() (+38 more)
...
### Community 63 - "TickType_t"
Cohesion: 0.09
Nodes (34): crCOROUTINE_CODE, osThreadFlagsWait(), BaseType_t, List_t, TickType_t, UBaseType_t, prvCheckDelayedList(), prvCheckPendingReadyList() (+26 more)
...
### Community 65 - "analyze_nl_mount_vector_model.py"
Cohesion: 0.22
Nodes (29): build_pairs(), coefficient(), config_interaction_tables(), Curve, design_matrix(), energy_localization(), fit_fourier(), full_spectrum_rows() (+21 more)
...
### Community 83 - "System Architecture Review — NL + Power Component Split (2026-08-18)"
Cohesion: 0.07
Nodes (28): 10. Audit trail — counter-review of Revision 1, 11.1 Closing acceptance criteria (attached at sign-off, must be satisfied by §11.2 step 6), 11.2 Implementation order (locked), 11. Approval, closing acceptance criteria, and locked implementation order, 1. As-is assessment, 2.1 NL — confirms this project's existing formula, differs on sampling/grid detail, 2.2 Power — full algorithm, re-derived and independently verified against the source, 2. Reference requirements source: Gremsy's original implementation (+20 more)

### Community 84 - "analyze_scope_capture.py"
Cohesion: 0.26
Nodes (12): detect_transitions(), format_si_time(), load_waveform(), main(), parse_header(), DataFrame, ndarray, Path (+4 more)
...
Cohesion: 0.13
Nodes (17): MotorPwm_Disable(), MotorPwm_Enable(), MotorPwm_Init(), MotorPwm_PhaseValue(), MotorPwm_ResetCommand(), MotorPwm_SetElectricalPos(), gremsyMotorDisable(), gremsyMotorEnable() (+9 more)
...
Cohesion: 0.10
Nodes (27): analyze_motor_response_timing(), analyze_saved_log(), BatchLogRecorder, CompletedCapture, _configuration_health(), _cycles_to_ms(), _format_timing_stats(), MotorResponseTimingAnalysis (+19 more)
...
Cohesion: 0.50
Nodes (3): graphify, Mandatory project objective: pure open-loop NL, Session documentation discipline
...
### Community 302 - "RunNlMathSelfTestCase"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (41): ControlA4Report_t, ControlA4Result_t, AbsI32ToU32(), ControlA5CaptureReport_t, ControlA5Result_t, MA600_Sample_t, ControlA4PhaseProgressRaw(), ControlA4PowerPpm() (+33 more)

### Community 311 - "nonlinear_test.c"
Cohesion: 0.04
Nodes (84): AppEngine_Init(), Motor_GetCommandedPos(), AbsI64ToU64(), AccumulateCounterDelta(), MA600_AcquisitionContext_t, MA600_PointSample_t, MA600_PointSamplerConfig_t, MA600_Result_t (+76 more)
...
### Community 341 - "Phân rã nguyên nhân cross-jig — cùng motor/cùng firmware nhưng NL khác"
Cohesion: 0.07
Nodes (26): 1. Ranking cross-jig và giới hạn mẫu nhỏ, 2. Control cho phép loại harmonic, 3. A2 phase-vector: P013 là phản ví dụ cho mô hình thuần jig-side, 4. Verdict sau audit, Audit phản biện phương pháp luận — hạ mức kết luận H1/H2 và phân hạng bằng chứng, Ba đại lượng phải phân biệt, Bước tiếp theo được dữ liệu hỗ trợ, Causal conclusion có thể bảo vệ bằng dữ liệu (+18 more)
...
### Community 353 - "xTaskResumeAll"
Cohesion: 0.14
Nodes (27): BlockLink_t, ControlA5_CaptureResourcesInit(), HeapStats_t, osKernelRestoreLock(), osMemoryPoolNew(), osThreadEnumerate(), osTimerNew(), vEventGroupDelete() (+19 more)
...
### Community 396 - "stm32f4xx_hal_gpio.c"
Cohesion: 0.32
Nodes (7): GPIO_TypeDef, HAL_StatusTypeDef, __weak, HAL_GPIO_EXTI_Callback(), HAL_GPIO_EXTI_IRQHandler(), HAL_GPIO_LockPin(), HAL_GPIO_TogglePin()

### Community 397 - "RampCommandToTarget"
Cohesion: 0.48
Nodes (7): ExtendCommandBlind(), LockStartPosition(), NlSmoothstepCommandRaw(), RampCommandToTarget(), osDelayUntil(), osKernelGetTickCount(), NlMotionDiagnostics_t

### Community 398 - "HAL_SPI_RegisterCallback"
Cohesion: 0.50
...
Cohesion: 0.29
Nodes (7): 16.1 — P08/JIG8, same mount, A(v5.8 cap320)/B(v5.9a cap400), remount01, 16.2 — Independent remount, P08/JIG8 (remount03), 16.3 — P09/JIG8 non-regression (remount03), 16.4 — P03/JIG8 generalization (remount01 + remount02, two independent mounts), Combined terminal-mechanism total across all 5 mounts, 3 products, Decision, V5.9a hardware validation — sections 16.1–16.4 complete, 5 mounts, 3 products
...
### Community 431 - "TIM_Base_SetConfig"
Cohesion: 0.15
...
### Community 432 - "stm32f4xx_hal_rcc.c"
Cohesion: 0.17
...
### Community 434 - "Session summary — 2026-08-19"
Cohesion: 0.15
Nodes (12): Conceptual note: why a path-pair can look consistent across motors while motors still differ, Consolidated NL value table (RawP2P, CV, A36) for this session's path/sensor work, Critical correction: run05-run08 were mislabeled P013, actually P010, Full path-2 evaluation across motors (2300mm, old sensor) -- reverses the "path 2 is bad" read, Open items for next session, P013/JIG7 sensor-gap and mechanical-path investigation (run01-run09), Path 1 data added for P08 and P011; direct path1-vs-path2 curve comparison, QuickScreen3Run firmware build (+4 more)

### Community 435 - "NL mounting-vector model assessment"
Cohesion: 0.17
Nodes (11): 1. How many harmonics are needed?, 2. Config-only model versus motor×config interaction, 3. Reference-frame validity check using motor-intrinsic H36, 4. H1/H2 phase and the N-S transition hypothesis, 5. PCA, 6. Largest residual spectral terms after the low-order region, Executive conclusions, Generated evidence (+3 more)

### Community 436 - "Session summary — 2026-08-12"
Cohesion: 0.18
Nodes (10): A1/A2 cross-jig deep dive — evidence points to jig-locked, not motor-locked, AGENTS.md RULE 0 extended: two objectives, explicit no-threshold rule, Cross-tab P03 x P08 on JIG7/JIG8 -- same-jig correlation beats same-motor cross-jig correlation, New product P010 on JIG7 -- independent test of the jig-locked hypothesis, P08 on JIG8 -- 5th data point complicates the jig-locked hypothesis, does not confirm it, Reconciled with the polar-chart method — was a unit bug on this session's side, not a real contradiction, S5.2 (remount, controlled torque) — P03/JIG8/remount02, PASS, Session summary — 2026-08-12 (+2 more)

### Community 437 - "Metrology verdict — current open-loop NL method and error budget"
Cohesion: 0.14
Nodes (13): Classification, Classification and contract, Decision advanced, Evidence and findings, Inputs and checks, Measurement-system decision, Metrology verdict — current open-loop NL method and error budget, NL mounting-vector model — full dataset evaluation (+5 more)

### Community 438 - "cmsis_compiler.h"
Cohesion: 0.36
Nodes (7): packed, __PACKED_STRUCT, T_UINT16_READ(), T_UINT16_WRITE(), T_UINT32(), T_UINT32_READ(), T_UINT32_WRITE()

### Community 439 - "Open-loop NL direction correction — RULE 0 locked, S0-S4 executed, first clean hardware pilot"
Cohesion: 0.29
Nodes (7): Independent review caught two real gaps, both fixed, Open-loop NL direction correction — RULE 0 locked, S0-S4 executed, first clean hardware pilot, Root-cause audit (ALG-001/004/005 re-examined against current code), RULE 0 locked (`AGENTS.md` + `docs/open-loop-nl-direction-correction-handoff-2026-08-12.md`), S0/S1 implemented and verified this session, S2/S3 rebuilt, S4 hardware pilot run — first real open-loop schema-v6 data, Status and next step

### Community 440 - "Extreme points on each batch-mean curve"
Cohesion: 0.33
Nodes (5): Extreme points on each batch-mean curve, NL extreme-angle and cross-jig curve analysis, P010 / JIG7, P010 / JIG8, Same-motor cross-jig comparison

### Community 441 - "Extreme points on each batch-mean curve"
Cohesion: 0.33
Nodes (5): Extreme points on each batch-mean curve, NL extreme-angle and cross-jig curve analysis, P011 / JIG7, P011 / JIG8, Same-motor cross-jig comparison

### Community 442 - "Extreme points on each batch-mean curve"
Cohesion: 0.33
Nodes (5): Extreme points on each batch-mean curve, NL extreme-angle and cross-jig curve analysis, P013 / JIG7, P013 / JIG8, Same-motor cross-jig comparison

### Community 443 - "Extreme points on each batch-mean curve"
Cohesion: 0.33
Nodes (5): Extreme points on each batch-mean curve, NL extreme-angle and cross-jig curve analysis, P03 / JIG7, P03 / JIG8, Same-motor cross-jig comparison

### Community 444 - "Extreme points on each batch-mean curve"
Cohesion: 0.33
Nodes (5): Extreme points on each batch-mean curve, NL extreme-angle and cross-jig curve analysis, P08 / JIG7, P08 / JIG8, Same-motor cross-jig comparison

### Community 445 - "P013 -- 5th product, both jigs tested together; confirms JIG8 cluster, breaks JIG7 cluster"
Cohesion: 0.40
Nodes (5): A2 physical angle -- JIG8 cluster strengthens, JIG7 cluster breaks for the first time, Curve correlation, P013 -- 5th product, both jigs tested together; confirms JIG8 cluster, breaks JIG7 cluster, Read, Scalars -- one of the tightest cross-jig scalar matches today

### Community 446 - "P010 on JIG8 -- reverses the read above, P010 correlates poorly everywhere"
Cohesion: 0.40
Nodes (5): A2 physical angle: P010/JIG8 clusters with P03/JIG8, not with P08/JIG8, Correlation: P010 correlates weakly with everything, not just cross-jig, P010 on JIG8 -- reverses the read above, P010 correlates poorly everywhere, Scalar: P010's cross-jig gap is much larger than P03's or P08's, Where this leaves the picture

### Community 447 - "P08 on JIG7 -- 6th point lands the cluster, reframes the hypothesis again"
Cohesion: 0.40
Nodes (5): A2 physical angle: P08/JIG7 = 30.9/210.9 deg, Curve correlation: P08 syncs cross-jig much better than P03 did, P08 on JIG7 -- 6th point lands the cluster, reframes the hypothesis again, Reframed hypothesis, Scalar/harmonic: P08 JIG8 -> JIG7

### Community 448 - "MATLAB tooling catch-up for schema v6 + independent polar-chart cross-check"
Cohesion: 0.40
Nodes (5): Answered: does a different jig always produce a "bad" angle range somewhere?, Attempted (and correctly abandoned) cross-reference to closed-loop response data, MATLAB tooling catch-up for schema v6 + independent polar-chart cross-check, New tools (commit `9f95ac7`, already pushed), Polar chart, independent MATLAB implementation vs the existing Python one

### Community 449 - "V5.9 EXTENDED terminal correction — implementation complete, V5.9a pilot packaged"
Cohesion: 0.40
Nodes (5): Next physical step, S2 — firmware (`Core/Src/nonlinear_test.c`), S3 — analysis tooling, S4 — regression + packaging, V5.9 EXTENDED terminal correction — implementation complete, V5.9a pilot packaged

### Community 450 - "S5.3 (cross-jig, same motor) — P03 moved JIG8 -> JIG7, objective 2 NOT YET met"
Cohesion: 0.50
Nodes (4): 360-point curve correlation, full +/-180 shift search (not assuming 0 this time), S5.3 (cross-jig, same motor) — P03 moved JIG8 -> JIG7, objective 2 NOT YET met, S5.3 verdict, Scalar/harmonic comparison (JIG8 remount02 vs JIG7)

### Community 451 - "P013 remounted on both jigs (JIG8 run02, JIG7 run03) -- refutes the "mounting artifact" guess"
Cohesion: 0.50
Nodes (4): A2 physical angle -- all four P013 readings cluster together, none match the JIG7 group, P013 remounted on both jigs (JIG8 run02, JIG7 run03) -- refutes the "mounting artifact" guess, Read -- reverses the prior tentative guess, Remount repeatability is tight on BOTH jigs -- not a mounting-artifact case

### Community 452 - "P011 -- 4th product, first test on both jigs"
Cohesion: 0.50
Nodes (4): A2 physical angle -- JIG8 cluster now has 3 of 4 products, Curve correlation, P011 -- 4th product, first test on both jigs, Scalars

### Community 453 - "P010 JIG7 remount (run02) -- best-mount pair shows P010 converges to P03/P08's cross-jig quality"
Cohesion: 0.50
Nodes (4): Best-mount cross-jig comparison (run02 vs run02) -- the key result, JIG7 remount also shifted, but less than JIG8's did, P010 JIG7 remount (run02) -- best-mount pair shows P010 converges to P03/P08's cross-jig quality, Where this leaves objective 2

### Community 454 - "P010 JIG8 remount (run02) -- confirms run01 was a mounting artifact, but reveals a new finding"
Cohesion: 0.50
Nodes (4): Curve correlation confirms the user's direct observation, New finding: P010's own remount repeatability is looser than P03's, P010 JIG8 remount (run02) -- confirms run01 was a mounting artifact, but reveals a new finding, Scalars land in the same range as JIG7 now (unlike run01)

### Community 455 - "Q: What did S4 P03 JIG8 open-loop run01 prove, and what blocked qualification?"
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: What did S4 P03 JIG8 open-loop run01 prove, and what blocked qualification?

### Community 456 - "Q: Did S4 P03 JIG8 remount01 open-loop run02 pass the runtime qualification gates after the META atomicity fix?"
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: Did S4 P03 JIG8 remount01 open-loop run02 pass the runtime qualification gates after the META atomicity fix?

### Community 457 - "Q: What do the latest S4 pure open-loop logs show about NL stability and synchronization between JIG7 and JIG8?"
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: What do the latest S4 pure open-loop logs show about NL stability and synchronization between JIG7 and JIG8?

### Community 458 - "Q: Why do the same 6-pole-pair motors running identical S4 pure open-loop firmware produce different NL on JIG7 and JIG8?"
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: Why do the same 6-pole-pair motors running identical S4 pure open-loop firmware produce different NL on JIG7 and JIG8?

### Community 459 - "Q: Audit the methodological critique of the 2026-08-18 S4 cross-jig open-loop NL analysis."
Cohesion: 0.50
Nodes (3): Answer, Outcome, Q: Audit the methodological critique of the 2026-08-18 S4 cross-jig open-loop NL analysis.

### Community 460 - "S5.1 (A/B/A, same mount, no remount) — legacy vs open-loop, P03/JIG8/remount01"
Cohesion: 0.67
Nodes (3): Direct 360-point curve correlation (this turn's actual diagnostic), S5.1 (A/B/A, same mount, no remount) — legacy vs open-loop, P03/JIG8/remount01, Scalar comparison

## Knowledge Gaps
- **1688 isolated node(s):** `v`, `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed` (+1683 more)
...
- **Why does `HAL_GetTick()` connect `HAL_GetTick` to `stm32f4xx_hal.c`, `LogLine`, `stm32f4xx_hal_rcc_ex.c`, `stm32f4xx_hal_uart.c`, `RampCommandToTarget`, `stm32f4xx_hal_spi.c`, `stm32f4xx_hal_dma.c`, `stm32f4xx_hal_rcc.c`, `control_a5_capture.c`, `stm32f4xx_hal_adc.c`, `control_engine.c`, `nonlinear_test.c`, `stm32f4xx_hal_flash_ex.c`, `stm32f4xx_hal_i2c.c`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `LL_MPU_Enable()` connect `stm32f4xx_ll_cortex.h` to `__DSB`?**
  _High betweenness centrality (0.030) - this node is a cross-community bridge._
- **Why does `main()` connect `main` to `ma600.c`, `cmsis_os2.c`, `stm32f4xx_hal.c`, `ma600_acquisition.c`, `TIM_Base_SetConfig`, `control_engine.c`, `nonlinear_test.c`?**
