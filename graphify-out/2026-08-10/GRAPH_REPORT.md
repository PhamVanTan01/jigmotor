...
Cohesion: 0.04
Nodes (93): NonlinearEngine_RequestStart(), MemPool_t, AllocBlock(), StackType_t, __STATIC_INLINE, StaticTask_t, TaskHandle_t, TimerHandle_t (+85 more)
...
Cohesion: 0.05
Nodes (93): configSTACK_DEPTH_TYPE, eNotifyAction, eTaskState, HeapStats_t, MemoryRegion_t, osKernelRestoreLock(), osThreadExit(), osThreadFlagsWait() (+85 more)
...
Cohesion: 0.18
Nodes (15): BlockLink_t, osThreadEnumerate(), osThreadGetCount(), osTimerNew(), prvHeapInit(), prvInsertBlockIntoFreeList(), pvPortMalloc(), vPortFree() (+7 more)
