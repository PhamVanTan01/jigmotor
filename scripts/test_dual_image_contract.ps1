...
Assert-True ($controlEngine -match 'CONTROL_A4_TARGET_POWER_PPM\s+350000U' -and
    $controlEngine -match 'CONTROL_A4_MAX_TRAVEL_RAW' -and
    $controlEngine -match 'CONTROL_A4_MAX_ACTIVE_MS' -and
    $controlEngine -match 'Motor_Disable\(\)') `
    'Control A4 alignment path is missing its fail-safe envelope.'
