...
2. **Test 28 — reversal:** A0 và V3 dùng cùng sector; V3 bỏ reversal. Residual V3 cao hơn A0 bracket ` `[+0.02304°, +0.00958°]`, nên không có lợi ích từ bỏ reversal.

 `[+0.03598°, ## Các gate quan trọng
...
- Sector Test 28 khớp 10/10 trong ±91 raw, max ` đây là gate mô tả vì ba file không có wall-clock chung.
