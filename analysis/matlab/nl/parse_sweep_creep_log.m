...
%   Covers the V5.1/V5.2/V5.3 field evolution documented in
...
%   MaxObservedStepDeltaRaw/TraceCount), SWEEP_CREEP_STEP (V5.3+ only,
...
%   (numeric) or "" (string) rather than erroring, so V5.1/V5.2/V5.3 logs
...
configFields = ["SchemaVersion","TestID","SweepID","JigID","MotorID","Direction","Official", ...
    "Enabled","Protocol","SelectionRule","TriggerRaw","BaseBudgetRaw","BaseMaxIterations", ...
    ...
    "FineLandingProtocol","FineTargetPoint","FineEntryRaw","FineStepRaw","FineMaxIterations", ...
    "JumpThresholdRaw","FineRecoveryBudgetRaw","FineRecoveryMaxIterations","TraceCapacity"];
configNumeric = ~ismember(configFields, ["JigID","MotorID","Direction","Protocol", ...
    "SelectionRule","TargetCrossingGuard","RecoveryProtocol","FineLandingProtocol"]);
...
pointFields = ["SchemaVersion","TestID","SweepID","JigID","MotorID","Direction","Point", ...
    ...
    "StickSlipJumpDetected","MaxObservedStepDeltaRaw","TraceCount","FinalGapRaw","Result"];
